...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.wangEditor = e();
}(undefined, function () {
  "use strict";
  function t(t) {
    var e = void 0;return e = document.createElement("div"), e.innerHTML = t, e.children;
  }function e(t) {
    return !!t && (t instanceof HTMLCollection || t instanceof NodeList);
  }function n(t) {
    var n = document.querySelectorAll(t);return e(n) ? n : [n];
  }function i(o) {
    if (o) {
      if (o instanceof i) return o;this.selector = o;var r = o.nodeType,
          a = [];9 === r ? a = [o] : 1 === r ? a = [o] : e(o) || o instanceof Array ? a = o : "string" == typeof o && (o = o.replace("/\n/mg", "").trim(), a = 0 === o.indexOf("<") ? t(o) : n(o));var c = a.length;if (!c) return this;var A = void 0;for (A = 0; A < c; A++) {
        this[A] = a[A];
      }this.length = c;
    }
  }function o(t) {
    ...
    var n = void 0;for (n in t) {
      if (t.hasOwnProperty(n) && !1 === e.call(t, n, t[n])) break;
    }
  }function a(t, e) {
    var n = void 0,
        i = void 0,
        o = t.length || 0;for (n = 0; n < o && (i = t[n], !1 !== e.call(t, i, n)); n++) {}
  }function c(t) {
    ...
    var n = this,
        i = t.editor;this.menu = t, this.opt = e;var r = o('<div class="w-e-droplist"></div>'),
        a = e.$title,
        c = void 0;a && (c = a.html(), c = z(i, c), a.html(c), a.addClass("w-e-dp-title"), r.append(a));var A = e.list || [],
        s = e.type || "list",
        l = e.onClick || J,
        d = o('<ul class="' + ("list" === s ? "w-e-list" : "w-e-block") + '"></ul>');r.append(d), A.forEach(function (t) {
      var e = t.$elem,
          r = e.html();r = z(i, r), e.html(r);var a = t.value,
          c = o('<li class="w-e-item"></li>');e && (c.append(e), d.append(c), e.on("click", function (t) {
    ...
    var e = this;this.editor = t, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-list2"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new l(this, { width: 120, $title: o("<p>设置列表</p>"), type: "list", list: [{ $elem: o('<span><i class="w-e-icon-list-numbered"></i> 有序列表</span>'), value: "insertOrderedList" }, { $elem: o('<span><i class="w-e-icon-list2"></i> 无序列表</span>'), value: "insertUnorderedList" }], onClick: function onClick(t) {
        e._command(t);
      } });
  }function b(t) {
    var e = this;this.editor = t, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-paragraph-left"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new l(this, { width: 100, $title: o("<p>对齐方式</p>"), type: "list", list: [{ $elem: o('<span><i class="w-e-icon-paragraph-left"></i> 靠左</span>'), value: "justifyLeft" }, { $elem: o('<span><i class="w-e-icon-paragraph-center"></i> 居中</span>'), value: "justifyCenter" }, { $elem: o('<span><i class="w-e-icon-paragraph-right"></i> 靠右</span>'), value: "justifyRight" }], onClick: function onClick(t) {
        e._command(t);
      } });
  }function y(t) {
    var e = this;this.editor = t, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-pencil2"><i/></div>'), this.type = "droplist";var n = t.config,
        i = n.colors || [];this._active = !1, this.droplist = new l(this, { width: 120, $title: o("<p>文字颜色</p>"), type: "inline-block", list: i.map(function (t) {
        return { $elem: o('<i style="color:' + t + ';" class="w-e-icon-pencil2"></i>'), value: t };
      }), onClick: function onClick(t) {
        e._command(t);
      } });
  }function E(t) {
    var e = this;this.editor = t, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-paint-brush"><i/></div>'), this.type = "droplist";var n = t.config,
        i = n.colors || [];this._active = !1, this.droplist = new l(this, { width: 120, $title: o("<p>背景色</p>"), type: "inline-block", list: i.map(function (t) {
    ...
    this.editor = t;var e = c("w-e-img");this.$elem = o('<div class="w-e-menu" id="' + e + '"><i class="w-e-icon-image"><i/></div>'), t.imgMenuId = e, this.type = "panel", this._active = !1;
  }function D(t) {
    this.editor = t, this.menus = {};
  }function k(t) {
    var e = t.clipboardData || t.originalEvent && t.originalEvent.clipboardData,
        n = void 0;return n = null == e ? window.clipboardData && window.clipboardData.getData("text") : e.getData("text/plain"), A(n);
  }function M(t, e) {
    var n = t.clipboardData || t.originalEvent && t.originalEvent.clipboardData,
      ...
      var r = o.split("</html>");return 2 === r.length && (o = r[0]), o = o.replace(/<(meta|script|link).+?>/gim, ""), o = o.replace(/<!--.*?-->/gm, ""), o = e ? o.replace(/\s?(class|style)=('|").+?('|")/gim, "") : o.replace(/\s?class=('|").+?('|")/gim, "");
    }
  }function U(t) {
    var e = [];if (k(t)) return e;var n = t.clipboardData || t.originalEvent && t.originalEvent.clipboardData || {},
        i = n.items;return i ? (r(i, function (t, n) {
      var i = n.type;/image/i.test(i) && e.push(n.getAsFile());
    }), e) : e;
  }function S(t) {
    var e = [];return (t.childNodes() || []).forEach(function (t) {
      var n = void 0,
          i = t.nodeType;if (3 === i && (n = t.textContent), 1 === i) {
        n = {}, n.tag = t.nodeName.toLowerCase();for (var r = [], a = t.attributes || {}, c = a.length || 0, A = 0; A < c; A++) {
          var s = a[A];r.push({ name: s.name, value: s.value });
    ...
    if (null == t) throw new Error("错误：初始化编辑器时候未传入任何参数，请查阅文档");this.id = "wangEditor-" + W++, this.toolbarSelector = t, this.textSelector = e, this.customConfig = {};
  }var Y = [];i.prototype = { constructor: i, forEach: function forEach(t) {
      var e = void 0;for (e = 0; e < this.length; e++) {
        var n = this[e];if (!1 === t.call(n, n, e)) break;
      }return this;
    }, clone: function clone(t) {
      var e = [];return this.forEach(function (n) {
        e.push(n.cloneNode(!!t));
      }), o(e);
    }, get: function get(t) {
      var e = this.length;return t >= e && (t %= e), o(this[t]);
    }, first: function first() {
      return this.get(0);
    }, last: function last() {
      var t = this.length;return this.get(t - 1);
    }, on: function on(t, e, n) {
      n || (n = e, e = null);var i = [];return i = t.split(/\s+/), this.forEach(function (t) {
        i.forEach(function (i) {
          if (i) {
            if (Y.push({ elem: t, type: i, fn: n }), !e) return void t.addEventListener(i, n);t.addEventListener(i, function (t) {
              var i = t.target;i.matches(e) && n.call(i, t);
            });
          }
        });
      });
      ...
      return t ? this.forEach(function (e) {
        var n = void 0;e.className ? (n = e.className.split(/\s/), n = n.filter(function (t) {
          return !!t.trim();
        }), n.indexOf(t) < 0 && n.push(t), e.className = n.join(" ")) : e.className = t;
      }) : this;
    }, removeClass: function removeClass(t) {
      return t ? this.forEach(function (e) {
        var n = void 0;e.className && (n = e.className.split(/\s/), n = n.filter(function (e) {
          return !(!(e = e.trim()) || e === t);
        }), e.className = n.join(" "));
      }) : this;
    }, css: function css(t, e) {
      var n = t + ":" + e + ";";return this.forEach(function (e) {
        var i = (e.getAttribute("style") || "").trim(),
            o = void 0,
            r = [];i ? (o = i.split(";"), o.forEach(function (t) {
      ...
      var t = this[0];return t ? o(t.children) : null;
    }, childNodes: function childNodes() {
      var t = this[0];return t ? o(t.childNodes) : null;
      ...
      return this.forEach(function (t) {
        if (t.remove) t.remove();else {
          var e = t.parentElement;e && e.removeChild(t);
        }
      });
    }, isContain: function isContain(t) {
      var e = this[0],
          n = t[0];return e.contains(n);
      ...
      var e = this[0];return null == t ? e.innerHTML : (e.innerHTML = t, this);
    }, val: function val() {
      ...
      var n = document.querySelectorAll(t),
          i = n.length;if (!i) return null;var r = e || this[0];if ("BODY" === r.nodeName) return null;var a = r.parentElement,
    ...
    var n = t.config.langArgs || [],
        ...
        var n = e.editor,
          ...
          if (e) {
            (e.events || []).forEach(function (e) {
              var i = e.selector,
                  o = e.type,
                  r = e.fn || O;f[n].find(i).on(o, function (e) {
                e.stopPropagation(), r(e) && t.hide();
              });
            });
          }
        });var g = c.find("input[type=text],textarea");g.length && g.get(0).focus(), this.$container = c, this._hideOtherPanels(), G.push(e);
      }
    }, hide: function hide() {
      var t = this.menu,
          e = this.$container;e && e.remove(), G = G.filter(function (e) {
        return e !== t;
      });
    }, _hideOtherPanels: function _hideOtherPanels() {
      G.length && G.forEach(function (t) {
        var e = t.panel || {};e.hide && e.hide();
      });
    } }, p.prototype = { constructor: p, onClick: function onClick(t) {
      var e = this.editor,
          n = void 0;if (this._active) {
        if (!(n = e.selection.getSelectionContainerElem())) return;e.selection.createRangeByElem(n), e.selection.restoreSelection(), this._createPanel(n.text(), n.attr("href"));
      ...
      var n = this,
          ...
          l = new u(this, { width: 300, tabs: [{ title: "链接", tpl: '<div>\n                            <input id="' + r + '" type="text" class="block" value="' + t + '" placeholder="链接文字"/></td>\n                            <input id="' + i + '" type="text" class="block" value="' + e + '" placeholder="http://..."/></td>\n                            <div class="w-e-button-container">\n                                <button id="' + a + '" class="right">插入</button>\n                                <button id="' + A + '" class="gray right" style="display:' + s + '">删除链接</button>\n                            </div>\n                        </div>', events: [{ selector: "#" + a, type: "click", fn: function fn() {
              var t = o("#" + i),
                  e = o("#" + r),
                  a = t.val(),
                  c = e.val();return n._insertLink(c, a), !0;
            } }, { selector: "#" + A, type: "click", fn: function fn() {
              return n._delLink(), !0;
            } }] }] });l.show(), this.panel = l;
    }, _delLink: function _delLink() {
      if (this._active) {
        var t = this.editor;if (t.selection.getSelectionContainerElem()) {
          var e = t.selection.getSelectionText();t.cmd.do("insertHTML", "<span>" + e + "</span>");
        }
      }
      ...
      if (t && e) {
        var n = this.editor,
            i = n.config,
            o = i.linkCheck,
            r = !0;o && "function" == typeof o && (r = o(t, e)), !0 === r ? n.cmd.do("insertHTML", '<a href="' + e + '" target="_blank">' + t + "</a>") : alert(r);
      }
    }, tryChangeActive: function tryChangeActive(t) {
      var e = this.editor,
          n = this.$elem,
          i = e.selection.getSelectionContainerElem();i && ("A" === i.getNodeName() ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass("w-e-active")));
    } }, h.prototype = { constructor: h, onClick: function onClick(t) {
      var e = this.editor,
          n = e.selection.isSelectionEmpty();n && e.selection.createEmptyRange(), e.cmd.do("italic"), n && (e.selection.collapseRange(), e.selection.restoreSelection());
    }, tryChangeActive: function tryChangeActive(t) {
      var e = this.editor,
          n = this.$elem;e.cmd.queryCommandState("italic") ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass("w-e-active"));
    } }, f.prototype = { constructor: f, onClick: function onClick(t) {
      this.editor.cmd.do("redo");
    } }, g.prototype = { constructor: g, onClick: function onClick(t) {
      var e = this.editor,
          n = e.selection.isSelectionEmpty();n && e.selection.createEmptyRange(), e.cmd.do("strikeThrough"), n && (e.selection.collapseRange(), e.selection.restoreSelection());
    }, tryChangeActive: function tryChangeActive(t) {
      var e = this.editor,
          n = this.$elem;e.cmd.queryCommandState("strikeThrough") ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass("w-e-active"));
    } }, m.prototype = { constructor: m, onClick: function onClick(t) {
      var e = this.editor,
          n = e.selection.isSelectionEmpty();n && e.selection.createEmptyRange(), e.cmd.do("underline"), n && (e.selection.collapseRange(), e.selection.restoreSelection());
    }, tryChangeActive: function tryChangeActive(t) {
      var e = this.editor,
          n = this.$elem;e.cmd.queryCommandState("underline") ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass("w-e-active"));
    } }, w.prototype = { constructor: w, onClick: function onClick(t) {
      this.editor.cmd.do("undo");
    } }, v.prototype = { constructor: v, _command: function _command(t) {
      var e = this.editor,
          n = e.$textElem;if (e.selection.restoreSelection(), !e.cmd.queryCommandState(t)) {
        e.cmd.do(t);var i = e.selection.getSelectionContainerElem();if ("LI" === i.getNodeName() && (i = i.parent()), !1 !== /^ol|ul$/i.test(i.getNodeName()) && !i.equal(n)) {
          var o = i.parent();o.equal(n) || (i.insertAfter(o), o.remove());
        }
      }
    }, tryChangeActive: function tryChangeActive(t) {
      var e = this.editor,
          n = this.$elem;e.cmd.queryCommandState("insertUnOrderedList") || e.cmd.queryCommandState("insertOrderedList") ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass("w-e-active"));
    } }, b.prototype = { constructor: b, _command: function _command(t) {
      this.editor.cmd.do(t);
    } }, y.prototype = { constructor: y, _command: function _command(t) {
      this.editor.cmd.do("foreColor", t);
    } }, E.prototype = { constructor: E, _command: function _command(t) {
      this.editor.cmd.do("backColor", t);
    } }, x.prototype = { constructor: x, onClick: function onClick(t) {
      var e = this.editor,
          n = e.selection.getSelectionContainerElem(),
          i = n.getNodeName();if (!P.isIE()) return void ("BLOCKQUOTE" === i ? e.cmd.do("formatBlock", "<P>") : e.cmd.do("formatBlock", "<BLOCKQUOTE>"));var r = void 0,
          a = void 0;if ("P" === i) return r = n.text(), a = o("<blockquote>" + r + "</blockquote>"), a.insertAfter(n), void n.remove();"BLOCKQUOTE" === i && (r = n.text(), a = o("<p>" + r + "</p>"), a.insertAfter(n), n.remove());
    }, tryChangeActive: function tryChangeActive(t) {
      var e = this.editor,
          n = this.$elem,
          i = /^BLOCKQUOTE$/i,
          o = e.cmd.queryCommandValue("formatBlock");i.test(o) ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass("w-e-active"));
    } }, B.prototype = { constructor: B, onClick: function onClick(t) {
      var e = this.editor,
          ...
          c = void 0;return n.equal(i) ? r ? void (this._active ? this._createPanel(n.html()) : this._createPanel()) : (c = o("<code>" + a + "</code>"), e.cmd.do("insertElem", c), e.selection.createRangeByElem(c, !1), void e.selection.restoreSelection()) : void e.selection.restoreSelection();
    }, _createPanel: function _createPanel(t) {
      var e = this;t = t || "";var n = t ? "edit" : "new",
          i = c("texxt"),
          r = c("btn"),
          a = new u(this, { width: 500, tabs: [{ title: "插入代码", tpl: '<div>\n                        <textarea id="' + i + '" style="height:145px;;">' + t + '</textarea>\n                        <div class="w-e-button-container">\n                            <button id="' + r + '" class="right">插入</button>\n                        </div>\n                    <div>', events: [{ selector: "#" + r, type: "click", fn: function fn() {
              var t = o("#" + i),
                  r = t.val() || t.html();return r = A(r), "new" === n ? e._insertCode(r) : e._updateCode(r), !0;
            } }] }] });a.show(), this.panel = a;
      ...
      var e = this.editor,
          n = e.selection.getSelectionContainerElem();n && (n.html(t), e.selection.restoreSelection());
    }, tryChangeActive: function tryChangeActive(t) {
      var e = this.editor,
          n = this.$elem,
          i = e.selection.getSelectionContainerElem();if (i) {
    ...
    } }, C.prototype = { constructor: C, onClick: function onClick() {
      this._createPanel();
      ...
      var t = this,
        ...
        var n = e.type,
            i = e.content || [],
            a = "";"emoji" === n && i.forEach(function (t) {
          t && (a += '<span class="w-e-item">' + t + "</span>");
        }), "image" === n && i.forEach(function (t) {
          var e = t.src,
              n = t.alt;e && (a += '<span class="w-e-item"><img src="' + e + '" alt="' + n + '" data-w-e="1"/></span>');
        }), r.push({ title: e.title, tpl: '<div class="w-e-emoticon-container">' + a + "</div>", events: [{ selector: "span.w-e-item", type: "click", fn: function fn(e) {
              var n = e.target,
                  i = o(n),
                  r = i.getNodeName(),
                  a = void 0;return a = "IMG" === r ? i.parent().html() : "<span>" + i.html() + "</span>", t._insert(a), !0;
            } }] });
      });var a = new u(this, { width: 300, height: 200, tabs: r });a.show(), this.panel = a;
      ...
      var t = this,
          ...
          n = c("row"),
          i = c("col"),
          r = new u(this, { width: 250, tabs: [{ title: "插入表格", tpl: '<div>\n                        <p style="text-align:left; padding:5px 0;">\n                            创建\n                            <input id="' + n + '" type="text" value="5" style="width:40px;text-align:center;"/>\n                            行\n                            <input id="' + i + '" type="text" value="5" style="width:40px;text-align:center;"/>\n                            列的表格\n                        </p>\n                        <div class="w-e-button-container">\n                            <button id="' + e + '" class="right">插入</button>\n                        </div>\n                    </div>', events: [{ selector: "#" + e, type: "click", fn: function fn() {
              var e = parseInt(o("#" + n).val()),
                  r = parseInt(o("#" + i).val());return e && r && e > 0 && r > 0 && t._insert(e, r), !0;
            } }] }] });r.show(), this.panel = r;
    }, _insert: function _insert(t, e) {
      var n = void 0,
          i = void 0,
          o = '<table border="0" width="100%" cellpadding="0" cellspacing="0">';for (n = 0; n < t; n++) {
        if (o += "<tr>", 0 === n) for (i = 0; i < e; i++) {
          o += "<th>&nbsp;</th>";
        } else for (i = 0; i < e; i++) {
          o += "<td>&nbsp;</td>";
        }o += "</tr>";
      }o += "</table><p><br></p>";var r = this.editor;r.cmd.do("insertHTML", o), r.cmd.do("enableObjectResizing", !1), r.cmd.do("enableInlineTableEditing", !1);
      ...
      var t = this,
          ...
          r = c("del-table");new u(this, { width: 320, tabs: [{ title: "编辑表格", tpl: '<div>\n                        <div class="w-e-button-container" style="border-bottom:1px solid #f1f1f1;padding-bottom:5px;margin-bottom:5px;">\n                            <button id="' + e + '" class="left">增加行</button>\n                            <button id="' + i + '" class="red left">删除行</button>\n                            <button id="' + n + '" class="left">增加列</button>\n                            <button id="' + o + '" class="red left">删除列</button>\n                        </div>\n                        <div class="w-e-button-container">\n                            <button id="' + r + '" class="gray left">删除表格</button>\n                        </dv>\n                    </div>', events: [{ selector: "#" + e, type: "click", fn: function fn() {
              ...
              return t._delCol(), !0;
            } }, { selector: "#" + r, type: "click", fn: function fn() {
              return t._delTable(), !0;
            } }] }] }).show();
    }, _getLocationData: function _getLocationData() {
      var t = {},
          e = this.editor,
          n = e.selection.getSelectionContainerElem();if (n) {
        var i = n.getNodeName();if ("TD" === i || "TH" === i) {
          var o = n.parent(),
              r = o.children(),
              a = r.length;r.forEach(function (e, i) {
            if (e === n[0]) return t.td = { index: i, elem: e, length: a }, !1;
          });var c = o.parent(),
              A = c.children(),
              s = A.length;return A.forEach(function (e, n) {
            if (e === o[0]) return t.tr = { index: n, elem: e, length: s }, !1;
          }), t;
        }
      }
    }, _addRow: function _addRow() {
      var t = this._getLocationData();if (t) {
        var e = t.tr,
            n = o(e.elem),
            i = t.td,
            r = i.length,
      ...
      var t = this._getLocationData();if (t) {
        var e = t.tr,
            n = t.td,
            i = n.index;o(e.elem).parent().children().forEach(function (t) {
          var e = o(t),
              n = e.children(),
              r = n.get(i),
              a = r.getNodeName().toLowerCase();o(document.createElement(a)).insertAfter(r);
        });
      }
      ...
      var t = this.editor,
          e = t.selection.getSelectionContainerElem();if (e) {
        var n = e.parentUntil("table");n && n.remove();
      }
    }, tryChangeActive: function tryChangeActive(t) {
      var e = this.editor,
          n = this.$elem,
      ...
      var t = this,
          ...
          i = new u(this, { width: 350, tabs: [{ title: "插入视频", tpl: '<div>\n                        <input id="' + e + '" type="text" class="block" placeholder="格式如：<iframe src=... ></iframe>"/>\n                        <div class="w-e-button-container">\n                            <button id="' + n + '" class="right">插入</button>\n                        </div>\n                    </div>', events: [{ selector: "#" + n, type: "click", fn: function fn() {
              var n = o("#" + e),
                  i = n.val().trim();return i && t._insert(i), !0;
            } }] }] });i.show(), this.panel = i;
    }, _insert: function _insert(t) {
      this.editor.cmd.do("insertHTML", t + "<p><br></p>");
    } }, _.prototype = { constructor: _, onClick: function onClick() {
      ...
      var t = this.editor,
          ...
          i = c("width-100"),
          o = c("del-btn"),
          r = [{ title: "编辑图片", tpl: '<div>\n                    <div class="w-e-button-container" style="border-bottom:1px solid #f1f1f1;padding-bottom:5px;margin-bottom:5px;">\n                        <span style="float:left;font-size:14px;margin:4px 5px 0 5px;color:#333;">最大宽度：</span>\n                        <button id="' + e + '" class="left">30%</button>\n                        <button id="' + n + '" class="left">50%</button>\n                        <button id="' + i + '" class="left">100%</button>\n                    </div>\n                    <div class="w-e-button-container">\n                        <button id="' + o + '" class="gray left">删除图片</button>\n                    </dv>\n                </div>', events: [{ selector: "#" + e, type: "click", fn: function fn() {
            var e = t._selectedImg;return e && e.css("max-width", "30%"), !0;
          } }, { selector: "#" + n, type: "click", fn: function fn() {
            var e = t._selectedImg;return e && e.css("max-width", "50%"), !0;
          } }, { selector: "#" + i, type: "click", fn: function fn() {
            var e = t._selectedImg;return e && e.css("max-width", "100%"), !0;
          } }, { selector: "#" + o, type: "click", fn: function fn() {
            var e = t._selectedImg;return e && e.remove(), !0;
          } }] }],
          a = new u(this, { width: 300, tabs: r });a.show(), this.panel = a;
    }, _createInsertPanel: function _createInsertPanel() {
      var t = this.editor,
          e = t.uploadImg,
          n = t.config,
          ...
          s = [{ title: "上传图片", tpl: '<div class="w-e-up-img-container">\n                    <div id="' + i + '" class="w-e-up-btn">\n                        <i class="w-e-icon-upload2"></i>\n                    </div>\n                    <div style="display:none;">\n                        <input id="' + r + '" type="file" multiple="multiple" accept="image/jpg,image/jpeg,image/png,image/gif,image/bmp"/>\n                    </div>\n                </div>', events: [{ selector: "#" + i, type: "click", fn: function fn() {
            var t = o("#" + r),
                e = t[0];if (!e) return !0;e.click();
          } }, { selector: "#" + r, type: "change", fn: function fn() {
            var t = o("#" + r),
                n = t[0];if (!n) return !0;var i = n.files;return i.length && e.uploadImg(i), !0;
          } }] }, { title: "网络图片", tpl: '<div>\n                    <input id="' + a + '" type="text" class="block" placeholder="图片链接"/></td>\n                    <div class="w-e-button-container">\n                        <button id="' + A + '" class="right">插入</button>\n                    </div>\n                </div>', events: [{ selector: "#" + A, type: "click", fn: function fn() {
            var t = o("#" + a),
                n = t.val().trim();return n && e.insertLinkImg(n), !0;
          } }] }],
      ...
      var e = this.editor,
          n = this.$elem;e._selectedImg ? (this._active = !0, n.addClass("w-e-active")) : (this._active = !1, n.removeClass("w-e-active"));
    } };var $ = {};$.bold = s, $.head = d, $.link = p, $.italic = h, $.redo = f, $.strikeThrough = g, $.underline = m, $.undo = w, $.list = v, $.justify = b, $.foreColor = y, $.backColor = E, $.quote = x, $.code = B, $.emoticon = C, $.table = I, $.video = Q, $.image = _, D.prototype = { constructor: D, init: function init() {
      var t = this,
          e = this.editor;((e.config || {}).menus || []).forEach(function (n) {
        var i = $[n];i && "function" == typeof i && (t.menus[n] = new i(e));
      ...
      var t = this.editor,
          ...
          n = this.menus,
          i = t.config,
          o = i.zIndex + 1;r(n, function (t, n) {
        var i = n.$elem;i && (i.css("z-index", o), e.append(i));
      });
    }, _bindEvent: function _bindEvent() {
      var t = this.menus,
          e = this.editor;r(t, function (t, n) {
        var i = n.type;if (i) {
          var o = n.$elem,
              r = n.droplist;n.panel;"click" === i && n.onClick && o.on("click", function (t) {
      ...
      var e = this.editor,
          n = e.$textElem;if (null == t) return n.html();n.html(t), e.initSelection();
    }, getJSON: function getJSON() {
      return S(this.editor.$textElem);
    }, text: function text(t) {
      var e = this.editor,
          n = e.$textElem;if (null == t) return n.text();n.text("<p>" + t + "</p>"), e.initSelection();
    }, append: function append(t) {
      var e = this.editor;e.$textElem.append(o(t)), e.initSelection();
    }, _bindEvent: function _bindEvent() {
      ...
      function t(t) {
        e.selection.saveRange(), e.menus.changeActive();
          ...
          n = e.$textElem;n.on("keyup", t), n.on("mousedown", function (e) {
        n.on("mouseleave", t);
      ...
      function t(t) {
        var e = o("<p><br></p>");e.insertBefore(t), i.selection.createRangeByElem(e, !0), i.selection.restoreSelection(), t.remove();
      }function e(e) {
        var n = i.selection.getSelectionContainerElem(),
            o = n.parent();if ("<code><br></code>" === o.html()) return void t(n);if (o.equal(r)) {
          "P" !== n.getNodeName() && (n.text() || t(n));
        }
      }function n(t) {
        var e = i.selection.getSelectionContainerElem();if (e) {
          var n = e.parent(),
              r = e.getNodeName(),
              a = n.getNodeName();if ("CODE" === r && "PRE" === a && i.cmd.queryCommandSupported("insertHTML")) {
            if (!0 === i._willBreakCode) {
              var c = o("<p><br></p>");return c.insertAfter(n), i.selection.createRangeByElem(c, !0), i.selection.restoreSelection(), i._willBreakCode = !1, void t.preventDefault();
            }var A = i.selection.getRange().startOffset;i.cmd.do("insertHTML", "\n"), i.selection.saveRange(), i.selection.getRange().startOffset === A && i.cmd.do("insertHTML", "\n");var s = e.html().length;i.selection.getRange().startOffset + 1 === s && (i._willBreakCode = !0), t.preventDefault();
          }
        }
      }var i = this.editor,
          r = i.$textElem;r.on("keyup", function (t) {
        13 === t.keyCode && e(t);
      }), r.on("keydown", function (t) {
        if (13 !== t.keyCode) return void (i._willBreakCode = !1);n(t);
      });
    }, _clearHandle: function _clearHandle() {
      var t = this.editor,
          e = t.$textElem;e.on("keydown", function (t) {
        if (8 === t.keyCode) {
        ...
        if (8 === n.keyCode) {
          var i = void 0,
              r = e.html().toLowerCase().trim();r && "<br>" !== r || (i = o("<p><br/></p>"), e.html(""), e.append(i), t.selection.createRangeByElem(i, !1, !0), t.selection.restoreSelection());
        }
      });
    }, _pasteHandle: function _pasteHandle() {
      function t() {
        var t = Date.now(),
            e = !1;return t - a >= 500 && (e = !0), a = t, e;
      }var e = this.editor,
          n = e.config,
          i = n.pasteFilterStyle,
          o = n.pasteTextHandle,
          r = e.$textElem,
          a = 0;r.on("paste", function (n) {
        if (!P.isIE() && (n.preventDefault(), t())) {
          var r = M(n, i),
              a = k(n);a = a.replace(/\n/gm, "<br>"), o && "function" == typeof o && (r = "" + (o(r) || ""), a = "" + (o(a) || ""));var c = e.selection.getSelectionContainerElem();if (c) {
            var A = c.getNodeName();if ("CODE" === A || "PRE" === A) return void e.cmd.do("insertHTML", "<p>" + a + "</p>");if (r) try {
        ...
        if (!P.isIE() && (n.preventDefault(), t())) {
          var i = U(n);if (i && i.length) {
            var o = e.selection.getSelectionContainerElem();if (o) {
              var r = o.getNodeName();if ("CODE" !== r && "PRE" !== r) {
      ...
      var t = this.editor;t.$textElem.on("keydown", function (e) {
        if (9 === e.keyCode && t.cmd.queryCommandSupported("insertHTML")) {
          var n = t.selection.getSelectionContainerElem();if (n) {
            var i = n.parent(),
                o = n.getNodeName(),
                r = i.getNodeName();"CODE" === o && "PRE" === r ? t.cmd.do("insertHTML", "    ") : t.cmd.do("insertHTML", "&nbsp;&nbsp;&nbsp;&nbsp;"), e.preventDefault();
          }
        }
      });
    }, _imgHandle: function _imgHandle() {
      var t = this.editor,
          e = t.$textElem;e.on("click", "img", function (e) {
        var n = this,
            i = o(n);"1" !== i.attr("data-w-e") && (t._selectedImg = i, t.selection.createRangeByElem(i), t.selection.restoreSelection());
      }), e.on("click  keyup", function (e) {
        e.target.matches("img") || (t._selectedImg = null);
      });
    }, _dragHandle: function _dragHandle() {
      var t = this.editor;o(document).on("dragleave drop dragenter dragover", function (t) {
        t.preventDefault();
      }), t.$textElem.on("drop", function (e) {
        e.preventDefault();var n = e.dataTransfer && e.dataTransfer.files;n && n.length && t.uploadImg.uploadImg(n);
      });
    } }, R.prototype = { constructor: R, do: function _do(t, e) {
      var n = this.editor;if (n.selection.getRange()) {
        n.selection.restoreSelection();var i = "_" + t;this[i] ? this[i](e) : this._execCommand(t, e), n.menus.changeActive(), n.selection.saveRange(), n.selection.restoreSelection(), n.change && n.change();
      }
    }, _insertHTML: function _insertHTML(t) {
      var e = this.editor,
          n = e.selection.getRange();this.queryCommandSupported("insertHTML") ? this._execCommand("insertHTML", t) : n.insertNode ? (n.deleteContents(), n.insertNode(o(t)[0])) : n.pasteHTML && n.pasteHTML(t);
    }, _insertElem: function _insertElem(t) {
      var e = this.editor,
          n = e.selection.getRange();n.insertNode && (n.deleteContents(), n.insertNode(t[0]));
      ...
      if (t) return void (this._currentRange = t);var e = window.getSelection();if (0 !== e.rangeCount) {
      ...
      null == t && (t = !1);var e = this._currentRange;e && e.collapse(t);
      ...
      t = t || this._currentRange;var e = void 0;if (t) return e = t.commonAncestorContainer, o(1 === e.nodeType ? e : e.parentNode);
    }, getSelectionStartElem: function getSelectionStartElem(t) {
      t = t || this._currentRange;var e = void 0;if (t) return e = t.startContainer, o(1 === e.nodeType ? e : e.parentNode);
    }, getSelectionEndElem: function getSelectionEndElem(t) {
      t = t || this._currentRange;var e = void 0;if (t) return e = t.endContainer, o(1 === e.nodeType ? e : e.parentNode);
    }, isSelectionEmpty: function isSelectionEmpty() {
      var t = this._currentRange;return !(!t || !t.startContainer || t.startContainer !== t.endContainer || t.startOffset !== t.endOffset);
    }, restoreSelection: function restoreSelection() {
      var t = window.getSelection();t.removeAllRanges(), t.addRange(this._currentRange);
    }, createEmptyRange: function createEmptyRange() {
      var t = this.editor,
          e = this.getRange(),
          n = void 0;if (e && this.isSelectionEmpty()) try {
      ...
      if (t.length) {
        var i = t[0],
            o = document.createRange();n ? o.selectNodeContents(i) : o.selectNode(i), "boolean" == typeof e && o.collapse(e), this.saveRange(o);
      }
    } }, T.prototype = { constructor: T, show: function show(t) {
      var e = this;if (!this._isShow) {
        this._isShow = !0;var n = this.$bar;if (this._isRender) this._isRender = !0;else {
          this.$textContainer.append(n);
        }Date.now() - this._time > 100 && t <= 1 && (n.css("width", 100 * t + "%"), this._time = Date.now());var i = this._timeoutId;i && clearTimeout(i), i = setTimeout(function () {
          e._hide();
        }, 500);
      }
    }, _hide: function _hide() {
      this.$bar.remove(), this._time = 0, this._isShow = !1, this._isRender = !1;
    } };var q = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (t) {
    return typeof t === "undefined" ? "undefined" : _typeof(t);
  } : function (t) {
    return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t === "undefined" ? "undefined" : _typeof(t);
  };j.prototype = { constructor: j, _alert: function _alert(t, e) {
      var n = this.editor,
          i = n.config.debug,
          o = n.config.customAlert;if (i) throw new Error("wangEditor: " + (e || t));o && "function" == typeof o ? o(t) : alert(t);
    }, insertLinkImg: function insertLinkImg(t) {
      var e = this;if (t) {
        var n = this.editor,
            i = n.config,
            o = i.linkImgCheck,
            r = void 0;if (o && "function" == typeof o && "string" == typeof (r = o(t))) return void alert(r);n.cmd.do("insertHTML", '<img src="' + t + '" style="max-width:100%;"/>');var a = document.createElement("img");a.onload = function () {
          var e = i.linkImgCallback;e && "function" == typeof e && e(t), a = null;
        }, a.onerror = function () {
      ...
      var e = this;if (t && t.length) {
        var n = this.editor,
          ...
          var v = [],
              b = [];if (a(t, function (t) {
            var e = t.name,
                n = t.size;if (e && n) return !1 === /\.(jpg|jpeg|png|bmp|gif)$/i.test(e) ? void b.push("【" + e + "】不是图片") : A < n ? void b.push("【" + e + "】大于 " + s + "M") : void v.push(t);
          }), b.length) return void this._alert("图片验证未通过: \n" + b.join("\n"));if (v.length > l) return void this._alert("一次最多上传" + l + "张图片");if (w && "function" == typeof w) return void w(v, this.insertLinkImg.bind(this));var y = new FormData();if (a(v, function (t) {
            var e = d || t.name;y.append(e, t);
          }), o && "string" == typeof o) {
            var E = o.split("#");o = E[0];var x = E[1] || "";r(u, function (t, e) {
              e = encodeURIComponent(e), p && (o.indexOf("?") > 0 ? o += "&" : o += "?", o = o + t + "=" + e), y.append(t, e);
            }), x && (o += "#" + x);var B = new XMLHttpRequest();if (B.open("POST", o), B.timeout = g, B.ontimeout = function () {
              f.timeout && "function" == typeof f.timeout && f.timeout(B, n), e._alert("上传图片超时");
            }, B.upload && (B.upload.onprogress = function (t) {
              var e = void 0,
                  i = new T(n);t.lengthComputable && (e = t.loaded / t.total, i.show(e));
            }), B.onreadystatechange = function () {
              var t = void 0;if (4 === B.readyState) {
                if (B.status < 200 || B.status >= 300) return f.error && "function" == typeof f.error && f.error(B, n), void e._alert("上传图片发生错误", "上传图片发生错误，服务器返回状态是 " + B.status);if (t = B.responseText, "object" !== (void 0 === t ? "undefined" : q(t))) try {
                  t = JSON.parse(t);
                } catch (i) {
              ...
              var C = f.before(B, n, v);if (C && "object" === (void 0 === C ? "undefined" : q(C)) && C.prevent) return void this._alert(C.msg);
            }return r(h, function (t, e) {
              B.setRequestHeader(t, e);
            }), B.withCredentials = m, void B.send(y);
          }c && a(t, function (t) {
            var n = e,
                i = new FileReader();i.readAsDataURL(t), i.onload = function () {
              n.insertLinkImg(this.result);
            };
          });
        }
      }
    } };var W = 1;H.prototype = { constructor: H, _initConfig: function _initConfig() {
      var t = {};this.config = Object.assign(t, L, this.customConfig);var e = this.config.lang || {},
          n = [];r(e, function (t, e) {
      ...
      var e = this.$textElem,
          n = e.children();if (!n.length) return e.append(o("<p><br></p>")), void this.initSelection();var i = n.last();if (t) {
        var r = i.html().toLowerCase(),
            a = i.getNodeName();if ("<br>" !== r && "<br/>" !== r || "P" !== a) return e.append(o("<p><br></p>")), void this.initSelection();
      }this.selection.createRangeByElem(i, !1, !0), this.selection.restoreSelection();
    }, _bindEvent: function _bindEvent() {
      var t = 0,
          e = this.txt.html(),
          n = this.config,
          i = n.onchangeTimeout;(!(i = parseInt(i, 10)) || i <= 0) && (i = 200);var o = n.onchange;o && "function" == typeof o && (this.change = function () {
        var n = this.txt.html();n.length === e.length && n === e || (t && clearTimeout(t), t = setTimeout(function () {
          o(n), e = n;
        }, i));
      });var r = n.onblur;r && "function" == typeof r && (this.onblur = function () {
        var t = this.txt.html();r(t);
      });var a = n.onfocus;a && "function" == typeof a && (this.onfocus = function () {
        a();
      });

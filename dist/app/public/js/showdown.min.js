  ...
  function g(g) {
    ...
    var C = A ? "Error in " + A + " extension->" : "Error in unnamed extension",
      ...
      var t = C + " sub-extension " + r + ": ",
          a = g[r];if ("object" != (typeof a === "undefined" ? "undefined" : _typeof(a))) return e.valid = !1, e.error = t + "must be an object, but " + (typeof a === "undefined" ? "undefined" : _typeof(a)) + " given", e;if (!I.helper.isString(a.type)) return e.valid = !1, e.error = t + 'property "type" must be a string, but ' + _typeof(a.type) + " given", e;var n = a.type = a.type.toLowerCase();if ("language" === n && (n = a.type = "lang"), "html" === n && (n = a.type = "output"), "lang" !== n && "output" !== n && "listener" !== n) return e.valid = !1, e.error = t + "type " + n + ' is not recognized. Valid values: "lang/language", "output/html" or "listener"', e;if ("listener" === n) {
        ...
        if ("object" != _typeof(a.listeners)) return e.valid = !1, e.error = t + '"listeners" property must be an object but ' + _typeof(a.listeners) + " given", e;for (var o in a.listeners) {
          if (a.listeners.hasOwnProperty(o) && "function" != typeof a.listeners[o]) return e.valid = !1, e.error = t + '"listeners" property must be an hash of [event name]: [callback]. listeners.' + o + " must be a function but " + _typeof(a.listeners[o]) + " given", e;
        }
      }if (a.filter) {
        if ("function" != typeof a.filter) return e.valid = !1, e.error = t + '"filter" must be a function, but ' + _typeof(a.filter) + " given", e;
      } else if (a.regex) {
        if (I.helper.isString(a.regex) && (a.regex = new RegExp(a.regex, "g")), !(a.regex instanceof RegExp)) return e.valid = !1, e.error = t + '"regex" property must either be a string or a RegExp object, but ' + _typeof(a.regex) + " given", e;if (I.helper.isUndefined(a.replace)) return e.valid = !1, e.error = t + '"regex" extensions must implement a replace string or function', e;
      }
    }return e;
  }function C(g, A) {
    "use strict";
    ...
    "use strict";
    if (!n.hasOwnProperty(g)) throw Error(g + " flavor was not found");I.resetOptions();var A = n[g];a = g;for (var C in A) {
      A.hasOwnProperty(C) && (t[C] = A[C]);
    }
    ...
    var e,
        ...
        c = [];do {
      for (e = 0; t = i.exec(g);) {
        if (l.test(t[0])) e++ || (a = (r = i.lastIndex) - t[0].length);else if (e && ! --e) {
    ...
    for (var e = o(g, A, C, I), r = [], t = 0; t < e.length; ++t) {
      r.push([g.slice(e[t].wholeMatch.start, e[t].wholeMatch.end), g.slice(e[t].match.start, e[t].match.end), g.slice(e[t].left.start, e[t].left.end), g.slice(e[t].right.start, e[t].right.end)]);
    }return r;
  }, I.helper.replaceRecursiveRegExp = function (g, A, C, e, r) {
    "use strict";
    if (!I.helper.isFunction(A)) {
      var t = A;A = function A() {
        return t;
      };
    }var a = o(g, C, e, r),
        n = g,
        s = a.length;if (s > 0) {
      var i = [];0 !== a[0].wholeMatch.start && i.push(g.slice(0, a[0].wholeMatch.start));for (var l = 0; l < s; ++l) {
        i.push(A(g.slice(a[l].wholeMatch.start, a[l].wholeMatch.end), g.slice(a[l].match.start, a[l].match.end), g.slice(a[l].left.start, a[l].left.end), g.slice(a[l].right.start, a[l].right.end))), l < s - 1 && i.push(g.slice(a[l].wholeMatch.end, a[l + 1].wholeMatch.start));
    ...
    function C(g, C) {
      if (C = C || null, I.helper.isString(g)) {
        if (g = I.helper.stdExtName(g), C = g, I.extensions[g]) return console.warn("DEPRECATION WARNING: " + g + " is an old extension that uses a deprecated loading method.Please inform the developer that the extension should be updated!"), void function (g, C) {
          "function" == typeof g && (g = g(new I.Converter()));I.helper.isArray(g) || (g = [g]);var e = A(g, C);if (!e.valid) throw Error(e.error);for (var r = 0; r < g.length; ++r) {
            switch (g[r].type) {case "lang":
        ...
        switch (g[a].type) {case "lang":
            ...
            i.push(g[a]);}if (g[a].hasOwnProperty("listeners")) for (var n in g[a].listeners) {
          g[a].listeners.hasOwnProperty(n) && e(n, g[a].listeners[n]);
        }
      }
    }function e(g, A) {
      if (!I.helper.isString(g)) throw Error("Invalid argument in converter.listen() method: name must be a string, but " + (typeof g === "undefined" ? "undefined" : _typeof(g)) + " given");if ("function" != typeof A) throw Error("Invalid argument in converter.listen() method: callback must be a function, but " + (typeof A === "undefined" ? "undefined" : _typeof(A)) + " given");l.hasOwnProperty(g) || (l[g] = []), l[g].push(A);
    }var o = {},
        s = [],
        i = [],
        l = {},
      ...
      }if ("object" != (typeof g === "undefined" ? "undefined" : _typeof(g))) throw Error("Converter expects the passed parameter to be an object, but " + (typeof g === "undefined" ? "undefined" : _typeof(g)) + " was passed instead.");for (var e in g) {
        g.hasOwnProperty(e) && (o[e] = g[e]);
      ...
      if (!n.hasOwnProperty(g)) throw Error(g + " flavor was not found");var A = n[g];c = g;for (var C in A) {
    ...
    "use strict";
    var e = function e(g, _e, r, t, a, n, o) {
      if (I.helper.isUndefined(o) && (o = ""), r = r.toLowerCase(), g.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1) t = "";else if (!t) {
        if (r || (r = _e.toLowerCase().replace(/ ?\n/g, " ")), t = "#" + r, I.helper.isUndefined(C.gUrls[r])) return g;t = C.gUrls[r], I.helper.isUndefined(C.gTitles[r]) || (o = C.gTitles[r]);
      }var s = '<a href="' + (t = t.replace(I.helper.regexes.asteriskDashAndColon, I.helper.escapeCharactersCallback)) + '"';return "" !== o && null !== o && (s += ' title="' + (o = (o = o.replace(/"/g, "&quot;")).replace(I.helper.regexes.asteriskDashAndColon, I.helper.escapeCharactersCallback)) + '"'), A.openLinksInNewWindow && !/^#/.test(t) && (s += ' target="Â¨E95Eblank"'), s += ">" + _e + "</a>";
    ...
    if (!A.completeHTMLDocument) return g;g = C.converter._dispatch("completeHTMLDocument.before", g, A, C);var I = "html",
        ...
        a = "",
        n = "";void 0 !== C.metadata.parsed.doctype && (e = "<!DOCTYPE " + C.metadata.parsed.doctype + ">\n", "html" !== (I = C.metadata.parsed.doctype.toString().toLowerCase()) && "html5" !== I || (t = '<meta charset="utf-8">'));for (var o in C.metadata.parsed) {
      if (C.metadata.parsed.hasOwnProperty(o)) switch (o.toLowerCase()) {case "doctype":
          break;case "title":
    ...
    return g = C.converter._dispatch("detab.before", g, A, C), g = g.replace(/\t(?=\t)/g, "    "), g = g.replace(/\t/g, "Â¨AÂ¨B"), g = g.replace(/Â¨B(.+?)Â¨A/g, function (g, A) {
      for (var C = A, I = 4 - C.length % 4, e = 0; e < I; e++) {
        C += " ";
      }return C;
    ...
    g = C.converter._dispatch("hashHTMLBlocks.before", g, A, C);var e = ["pre", "div", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "table", "dl", "ol", "ul", "script", "noscript", "form", "fieldset", "iframe", "math", "style", "section", "header", "footer", "nav", "article", "aside", "address", "audio", "canvas", "figure", "hgroup", "output", "video", "p"],
      ...
      for (var a, n = new RegExp("^ {0,3}(<" + e[t] + "\\b[^>]*>)", "im"), o = "<" + e[t] + "\\b[^>]*>", s = "</" + e[t] + ">"; -1 !== (a = I.helper.regexIndexOf(g, n));) {
    ...
    "use strict";
    var e = function e(g, _e2, r, t, a, n, o) {
      return _e2 = _e2.toLowerCase(), r.match(/^data:.+?\/.+?;base64,/) ? C.gUrls[_e2] = r.replace(/\s/g, "") : C.gUrls[_e2] = I.subParser("encodeAmpsAndAngles")(r, A, C), n ? n + o : (o && (C.gTitles[_e2] = o.replace(/"|'/g, "&quot;")), A.parseImgDimensions && t && a && (C.gDimensions[_e2] = { width: t, height: a }), "");
    ...
    function e(g) {
      ...
      var a,
        ...
        /^ {0,3}\|/.test(n[a]) && (n[a] = n[a].replace(/^ {0,3}\|/, "")), /\|[ \t]*$/.test(n[a]) && (n[a] = n[a].replace(/\|[ \t]*$/, "")), n[a] = I.subParser("codeSpans")(n[a], A, C);
        ...
        return g.trim();
          ...
          l = [],
          c = [],
          u = [];for (n.shift(), n.shift(), a = 0; a < n.length; ++a) {
        "" !== n[a].trim() && i.push(n[a].split("|").map(function (g) {
          return g.trim();
        }));
      }if (o.length < s.length) return g;for (a = 0; a < s.length; ++a) {
        c.push(e(s[a]));

...
;(function (factory) {
    ...
    editormd.keyMaps = (_editormd$keyMaps = {}, _defineProperty(_editormd$keyMaps, key + "-1", "h1"), _defineProperty(_editormd$keyMaps, key + "-2", "h2"), _defineProperty(_editormd$keyMaps, key + "-3", "h3"), _defineProperty(_editormd$keyMaps, key + "-4", "h4"), _defineProperty(_editormd$keyMaps, key + "-5", "h5"), _defineProperty(_editormd$keyMaps, key + "-6", "h6"), _defineProperty(_editormd$keyMaps, key + "-B", "bold"), _defineProperty(_editormd$keyMaps, key + "-D", "datetime"), _defineProperty(_editormd$keyMaps, key + "Ctrl-E", function () {
        // emoji
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), _defineProperty(_editormd$keyMaps, key + "-Alt-G", "goto-line"), _defineProperty(_editormd$keyMaps, key + "-H", "hr"), _defineProperty(_editormd$keyMaps, key + "-I", "italic"), _defineProperty(_editormd$keyMaps, key + "-K", "code"), _defineProperty(_editormd$keyMaps, "Ctrl-L", function CtrlL() {
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), _defineProperty(_editormd$keyMaps, key + "-U", "list-ul"), _defineProperty(_editormd$keyMaps, "Shift-Ctrl-A", function ShiftCtrlA() {
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), _defineProperty(_editormd$keyMaps, "Shift" + key + "-C", "code"), _defineProperty(_editormd$keyMaps, "Shift" + key + "Q", "quote"), _defineProperty(_editormd$keyMaps, "Shift" + key + "S", "del"), _defineProperty(_editormd$keyMaps, "Shift" + key + "K", "tex"), _defineProperty(_editormd$keyMaps, "Shift-Alt-C", function ShiftAltC() {
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-Alt-C", "code-block"), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-H", "html-entities"), _defineProperty(_editormd$keyMaps, "Shift-Alt-H", "help"), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-E", "emoji"), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-U", "uppercase"), _defineProperty(_editormd$keyMaps, "Shift-Alt-U", "ucwords"), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-Alt-U", "ucfirst"), _defineProperty(_editormd$keyMaps, "Shift-Alt-L", "lowercase"), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-I", function () {
        var cm = this.cm;
        var cursor = cm.getCursor();
        var selection = cm.getSelection();
    ...
    }), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-Alt-I", "image"), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-L", "link"), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-O", "list-ol"), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-P", "preformatted-text"), _defineProperty(_editormd$keyMaps, "Shift-" + key + "-T", "table"), _defineProperty(_editormd$keyMaps, "Shift-Alt-P", "pagebreak"), _defineProperty(_editormd$keyMaps, "F9", "watch"), _defineProperty(_editormd$keyMaps, "F10", "preview"), _defineProperty(_editormd$keyMaps, "F11", "fullscreen"), _editormd$keyMaps);

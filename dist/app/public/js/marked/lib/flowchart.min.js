...
!function () {
  function a(b, c) {
    if (!b || "function" == typeof b) return c;var d = {};for (var e in c) {
      d[e] = c[e];
    }for (e in b) {
      b[e] && (d[e] = "object" == _typeof(d[e]) ? a(d[e], b[e]) : b[e]);
    }return d;
  }function b(a, b) {
    ...
    var d,
        e,
        f = "M{0},{1}";for (d = 2, e = 2 * c.length + 2; e > d; d += 2) {
      f += " L{" + d + "},{" + (d + 1) + "}";
    }var g = [b.x, b.y];for (d = 0, e = c.length; e > d; d++) {
      g.push(c[d].x), g.push(c[d].y);
    }var h = a.paper.path(f, g);h.attr("stroke", a.options["element-color"]), h.attr("stroke-width", a.options["line-width"]);var i = a.options.font,
        j = a.options["font-family"],
        k = a.options["font-weight"];return i && h.attr({ font: i }), j && h.attr({ "font-family": j }), k && h.attr({ "font-weight": k }), h;
  }function d(a, b, c, d) {
    var e, f;"[object Array]" !== Object.prototype.toString.call(c) && (c = [c]);var g = "M{0},{1}";for (e = 2, f = 2 * c.length + 2; f > e; e += 2) {
      g += " L{" + e + "},{" + (e + 1) + "}";
    }var h = [b.x, b.y];for (e = 0, f = c.length; f > e; e++) {
      h.push(c[e].x), h.push(c[e].y);
    }var i = a.paper.path(g, h);i.attr({ stroke: a.options["line-color"], "stroke-width": a.options["line-width"], "arrow-end": a.options["arrow-end"] });var j = a.options.font,
    ...
    }a = a || "", a = a.trim();for (var d = { symbols: {}, start: null, drawSVG: function drawSVG(a, b) {
        function c(a) {
    ...
    "use strict";
    if (null === this) throw new TypeError();var b = Object(this),
        c = b.length >>> 0;if (0 === c) return -1;var d = c;arguments.length > 1 && (d = Number(arguments[1]), d != d ? d = 0 : 0 !== d && d != 1 / 0 && d != -(1 / 0) && (d = (d > 0 || -1) * Math.floor(Math.abs(d))));for (var e = d >= 0 ? Math.min(d, c - 1) : c - Math.abs(d); e >= 0; e--) {
      if (e in b && b[e] === a) return e;
    }return -1;
    ...
    var a,
        ...
        e = 0,
        f = 0,
        g = 0;for (d = 0, e = this.symbols.length; e > d; d++) {
      a = this.symbols[d], a.width > b && (b = a.width), a.height > c && (c = a.height);
    }for (d = 0, e = this.symbols.length; e > d; d++) {
      a = this.symbols[d], a.shiftX(this.options.x + (b - a.width) / 2 + this.options["line-width"]), a.shiftY(this.options.y + (c - a.height) / 2 + this.options["line-width"]);

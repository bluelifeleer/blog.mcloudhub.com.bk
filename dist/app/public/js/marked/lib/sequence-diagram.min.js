...
!function () {
  ...
  function Diagram() {
    ...
    var s = /^(.+) as (\S+)$/i.exec(alias.trim());s ? (name = s[1].trim(), alias = s[2].trim()) : name = alias.trim(), name = name.replace(/\\n/gm, "\n");var i,
        actors = this.actors;for (i in actors) {
    ...
    function Parser() {
      ...
      var lexer = { EOF: 1, parseError: function parseError(str, hash) {
          ...
          if (this.done) return this.EOF;this._input || (this.done = !0);var token, match, tempMatch, index;this._more || (this.yytext = "", this.match = "");for (var rules = this._currentRules(), i = 0; i < rules.length; i++) {
        ...
        }, options: { "case-insensitive": !0 }, performAction: function performAction(yy, yy_, $avoiding_name_collisions, YY_START) {
...
}.call(undefined), "undefined" != typeof jQuery && function ($) {
  ...
  function AssertException(message) {
  ...
  };var BaseTheme = function BaseTheme(diagram) {
    this.init(diagram);
  };_.extend(BaseTheme.prototype, { init: function init(diagram) {
    ...
    }, init_paper: function init_paper(container) {
      this._paper = new Raphael(container, 320, 200);
    }, init_font: function init_font() {}, draw_line: function draw_line(x1, y1, x2, y2) {
      return this._paper.line(x1, y1, x2, y2);
    }, draw_rect: function draw_rect(x, y, w, h) {
    ...
    }, draw_self_signal: function draw_self_signal(signal, offsetY) {
    ...
    }, draw_signal: function draw_signal(signal, offsetY) {
    ...
    }, draw_note: function draw_note(note, offsetY) {
    ...
    }, draw_text: function draw_text(x, y, text, font) {
      var t,
          paper = this._paper,
    ...
    }, draw_text_box: function draw_text_box(box, text, margin, padding, font) {
      var x = box.x + margin,
          y = box.y + margin,
    ...
    } });var RaphaëlTheme = function RaphaëlTheme(diagram) {
    this.init(diagram);
  };_.extend(RaphaëlTheme.prototype, BaseTheme.prototype, { init_font: function init_font() {
      this._font = { "font-size": 16, "font-family": "Andale Mono, monospace" };
    } });var HandRaphaëlTheme = function HandRaphaëlTheme(diagram) {
    this.init(diagram);
  };_.extend(HandRaphaëlTheme.prototype, BaseTheme.prototype, { init_font: function init_font() {
      this._font = { "font-size": 16, "font-family": "daniel" }, this._font._obj = this._paper.getFont("daniel");
    }, draw_line: function draw_line(x1, y1, x2, y2) {

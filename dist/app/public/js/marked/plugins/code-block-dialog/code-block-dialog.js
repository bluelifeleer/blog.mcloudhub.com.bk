				...
				var factory = function factory(exports) {
								...
								exports.fn.codeBlockDialog = function () {
												...
												if (editor.find("." + dialogName).length > 0) {
																...
																var dialogHTML = "<div class=\"" + classPrefix + "code-toolbar\">" + dialogLang.selectLabel + "<select><option selected=\"selected\" value=\"\">" + dialogLang.selectDefaultText + "</option></select>" + "</div>" + "<textarea placeholder=\"coding now....\" style=\"display:none;\">" + selection + "</textarea>";

...
(function () {
	...
	var factory = function factory(exports) {
		...
		var logos = [logoPrefix, logoPrefix + "-1x", logoPrefix + "-2x", logoPrefix + "-3x", logoPrefix + "-4x", logoPrefix + "-5x", logoPrefix + "-6x", logoPrefix + "-7x", logoPrefix + "-8x"];
		...
		exports.fn.emojiDialog = function () {
			...
			var dialogContent = ["<div class=\"" + classPrefix + "emoji-dialog-box\" style=\"width: 760px;height: 334px;margin-bottom: 8px;overflow: hidden;\">", "<div class=\"" + classPrefix + "tab\"></div>", "</div>"].join("\n");
			...
			var drawTable = function drawTable() {
				...
				var pagination = function pagination(data, type) {
